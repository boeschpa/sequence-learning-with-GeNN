...
# plot firing rates
ax[2].plot(np.tile(dense_time,(param.N_patterns,1)).T,firing_rate.T,label=["Pattern A", "Pattern B", "Pattern C"])
ax[2].plot(dense_time_basket,firing_rate_basket,color='r', label="Basket cells")
ax[2].plot(dense_time,firing_rate_pyramidal,color='b', label="Pyramidal cells")
...
ax[1].set_ylabel('Basket neuron index')
ax[2].set_ylabel('Average firing rate (Hz)')
