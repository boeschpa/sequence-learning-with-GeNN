...
int main(int argc, char** argv)
{
    ...
    writeTextSpikeArrayRecording("output.basketSpikes_"+std::to_string(seed)+".csv", recordBasketSpkArray, std::end(recordBasketSpkArray) - std::begin(recordBasketSpkArray),
