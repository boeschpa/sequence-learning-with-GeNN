...
ax[0].annotate("A", xy=(0, 0), xytext=(-15, -15), ha='right', va='top', fontsize=14, fontweight='bold')
ax[1].annotate("B", xy=(0, 0), xytext=(-15, -15), ha='right', va='top', fontsize=14, fontweight='bold')
